...
## TRAIN method 2 - orig xgboost API
dxgb_train = xgb.DMatrix(X_train, label = y_train)
param = {'max_depth':10, 'eta':0.1, 'objective':'binary:logistic', 'silent':1, 'nthread': multiprocessing.cpu_count()}
